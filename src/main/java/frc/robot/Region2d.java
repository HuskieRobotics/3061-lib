...
public class Region2d {
    ...
    /**
     * Create a Region2d, a polygon, from an array of Translation2d specifiying verticies of a polygon.
     ...
     * Normally, this operation will be performed once per transition with the transition point on
     * at the center of the boundary between the two regions.
    ...
    /**
     * Get the transition pont between this region and another region. Returns null if they aren't a neighbor.
     * @param other  the other region
