...
public class NovaCTRETCFRobotConfig extends RobotConfig {
  ...
  private static final double TRACKWIDTH_METERS = 0.523875; // 22.75
  private static final double WHEELBASE_METERS = 0.52705; // 22.75
  private static final double ROBOT_WIDTH_WITH_BUMPERS = 0.8382; // meters //34..75 in , measuyre the actual bumpers
  private static final double ROBOT_LENGTH_WITH_BUMPERS = 0.8382; // meters // 33 in same above
