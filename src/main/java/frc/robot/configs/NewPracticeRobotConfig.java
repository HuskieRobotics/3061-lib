...
public class NewPracticeRobotConfig extends RobotConfig {
  ...
  private static final Angle FRONT_LEFT_MODULE_STEER_OFFSET = Rotations.of(0.271729); // tune
  ...
  private static final Angle FRONT_RIGHT_MODULE_STEER_OFFSET = Rotations.of(-0.280518); // tune
  ...
  private static final Angle BACK_LEFT_MODULE_STEER_OFFSET = Rotations.of(-0.487305); // tune
  ...
  private static final Angle BACK_RIGHT_MODULE_STEER_OFFSET = Rotations.of(-0.106201); // tune
