...
public class NovaCTRERobotConfig extends RobotConfig {
  ...
  private static final double FRONT_LEFT_MODULE_STEER_OFFSET_ROT = -0.604492;
  ...
  private static final double BACK_LEFT_MODULE_STEER_OFFSET_ROT = -0.249512;
  ...
  private static final double ANGLE_KS = 0.0; // 0.1891233333;
  private static final double ANGLE_KV = 0.0; // 0.4399866667;
  private static final double ANGLE_KA = 0.0; // 0.001663333333;
  ...
  private static final double DRIVE_KS = 0.0; // 0.4004375;
  private static final double DRIVE_KV = 0.0; // 2.7637325;
  private static final double DRIVE_KA = 0.0; // 0.0139575;
