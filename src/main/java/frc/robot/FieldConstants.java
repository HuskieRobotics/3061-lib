...
public final class FieldConstants{
    ...
    public static final Translation2d[] COMMUNITY_REGION_POINTS_1 = new Translation2d[] {
        COMMUNITY_POINT_1, COMMUNITY_POINT_2, COMMUNITY_POINT_3, COMMUNITY_POINT_10
    };
    public static final Translation2d[] COMMUNITY_REGION_POINTS_2 = new Translation2d[] {
        COMMUNITY_POINT_6, COMMUNITY_POINT_3, COMMUNITY_POINT_4, COMMUNITY_POINT_5
    };
    public static final Translation2d[] COMMUNITY_REGION_POINTS_3 = new Translation2d[] {
    ...
    public final static Pose2d GRID_1_NODE_1 = new Pose2d(2, 0.51, Rotation2d.fromDegrees(180));
    public final static Pose2d GRID_1_NODE_2 = new Pose2d(2, 1.05, Rotation2d.fromDegrees(180));
    public final static Pose2d GRID_1_NODE_3 = new Pose2d(2, 1.63, Rotation2d.fromDegrees(180));

    public final static Pose2d GRID_2_NODE_1 = new Pose2d(2, 2.19, Rotation2d.fromDegrees(180));
    public final static Pose2d GRID_2_NODE_2 = new Pose2d(2, 2.75, Rotation2d.fromDegrees(180));
    public final static Pose2d GRID_2_NODE_3 = new Pose2d(2, 3.31, Rotation2d.fromDegrees(180));

    public final static Pose2d GRID_3_NODE_1 = new Pose2d(2, 3.87, Rotation2d.fromDegrees(180));
    public final static Pose2d GRID_3_NODE_2 = new Pose2d(2, 4.42, Rotation2d.fromDegrees(180));
    public final static Pose2d GRID_3_NODE_3 = new Pose2d(2, 4.98, Rotation2d.fromDegrees(180));
}