package first.lib.team3061.util;
 ...
 * replay.
 */
public class DifferentialRobotOdometry extends RobotOdometry {
  private DifferentialDrivePoseEstimator estimator = null;

  public DifferentialRobotOdometry() {
    estimator =
        new DifferentialDrivePoseEstimator(
            RobotConfig.getInstance().getDifferentialDriveKinematics(),
            new Rotation2d(),
            0.0,
            0.0,
            new Pose2d());
  ...
  public void resetPose(
    ...
    this.estimator.resetPosition(gyroAngle, leftPositionMeters, rightPositionMeters, poseMeters);
  }
  ...
  public Pose2d updateWithTime(
    ...
    return this.estimator.updateWithTime(
        currentTimeSeconds, gyroAngle, distanceLeftMeters, distanceRightMeters);
  }
