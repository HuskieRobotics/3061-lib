...
import first.lib.team3061.RobotConfig.CameraConfig;
import first.lib.team3061.differential_drivetrain.DifferentialDrivetrain;
import first.lib.team3061.differential_drivetrain.DifferentialDrivetrainIOXRP;
import first.lib.team3061.leds.LEDs;
import first.lib.team3061.swerve_drivetrain.SwerveDrivetrain;
import first.lib.team3061.swerve_drivetrain.SwerveDrivetrainIO;
import first.lib.team3061.swerve_drivetrain.SwerveDrivetrainIOCTRE;
import first.lib.team3061.vision.Vision;
import first.lib.team3061.vision.VisionIO;
import first.lib.team3061.vision.VisionIONorthstar;
import first.lib.team3061.vision.VisionIOPhotonVision;
import first.lib.team3061.vision.VisionIOSim;
import first.lib.team6328.util.FieldConstants;
import first.robot.Constants.Mode;
import first.robot.commands.ArmCommandFactory;
import first.robot.commands.AutonomousCommandsFactory;
import first.robot.commands.CrossSubsystemsCommandsFactory;
import first.robot.commands.DifferentialDrivetrainCommandFactory;
import first.robot.commands.ElevatorCommandsFactory;
import first.robot.commands.SwerveDrivetrainCommandFactory;
import first.robot.configs.DefaultRobotConfig;
import first.robot.configs.NewPracticeRobotConfig;
import first.robot.configs.NorthstarTestPlatformConfig;
import first.robot.configs.PracticeBoardConfig;
import first.robot.configs.SavannaRobotConfig;
import first.robot.configs.VisionTestPlatformConfig;
import first.robot.configs.XRPRobotConfig;
import first.robot.operator_interface.OISelector;
...
import first.robot.subsystems.arm.ArmIOXRP;
import first.robot.subsystems.elevator.Elevator;
import first.robot.subsystems.elevator.ElevatorIO;
import first.robot.subsystems.elevator.ElevatorIOTalonFX;
import first.robot.subsystems.manipulator.Manipulator;
import first.robot.subsystems.manipulator.ManipulatorIO;
import first.robot.subsystems.manipulator.ManipulatorIOTalonFX;
import first.robot.subsystems.shooter.Shooter;
import first.robot.subsystems.shooter.ShooterIO;
import first.robot.subsystems.shooter.ShooterIOTalonFX;
import first.robot.visualizations.RobotVisualization;
